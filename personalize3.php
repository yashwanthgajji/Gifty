...
session_start();
 include 'db.php';
 $y2=$_GET["y2"];
 $q1=mysqli_query($connection,"select * from product where productId='$y2'");
...
<script class="jsbin" src="http://ajax.googleapis.com/ajax/libs/jqueryui/1.8.0/jquery-ui.min.js"></script>
    ...
    <link type="text/css" rel="stylesheet" href="css/jquery.miniColors1.css" />
    ...
    <div class="container">
        ...
        if (input.files && input.files[0]) {
		    ...
		    <div class="span6">		    
				...
				<!--	EDITOR      -->					
					<div id="shirtDiv" class="page" style="width: 430px; height: 530px; position: relative; background-color: rgb(255, 255, 255);">
						<img id="tshirtFacing" src="<?php echo $img ?>"></img>
						<div id="drawingArea" style="position: absolute;top: 50px;left: 20px;z-index: 10;width: 120px;height: 520px;">					
							<canvas id="tcanvas" width="195" height="330" class="hover" style="-webkit-user-select: none;"></canvas>
						</div>
					</div>
				</div>
				<div class="span3"> 
