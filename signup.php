...
<div class="container">
  ...
  <form class="form-horizontal" action=" " method="post"  id="reg_form">
    ...
    <div class="">
            ...
            <input class="form-control {$borderColor}" id="gen1" style="height:15px;width:15px;"  type="radio" checked>Male
                  </label>    
                <label class="radio-inline">
  ...
  <button type="submit" style="margin-top:20px;" class="btn btn-danger btn-block"><span class="glyphicon glyphicon-off"></span> SignUp</button>
          </form>
        </div>
