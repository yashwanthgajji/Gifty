...
session_start();
include 'db.php';
 $q1=mysqli_query($connection,'select * from product where productType="lsticker"'); 
 $product_type=[];
 $product_name=[];
 $details=[];
 $o_price=[];
...
<div class="container">
  <div class="row">
   <?php
    ...
    <div class="col-md-4">
      <div class="thumbnail">
          <form action="product_description2.php" method="post">
	  <?php
          ...
          <div class="product info">
            <ul>
             ...
             <div class="row">
                  ...
                  <div class="col-sm-6">
                  <ul>
                      <form action="lsticker.php" method="post">
                    <?php
